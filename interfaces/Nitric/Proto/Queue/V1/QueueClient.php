...
class QueueClient extends \Grpc\BaseStub {
    ...
    public function Send(\Nitric\Proto\Queue\V1\QueueSendRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nitric.queue.v1.Queue/Send',
        $argument,
    ...
    public function SendBatch(\Nitric\Proto\Queue\V1\QueueSendBatchRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nitric.queue.v1.Queue/SendBatch',
        $argument,
    ...
    public function Receive(\Nitric\Proto\Queue\V1\QueueReceiveRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nitric.queue.v1.Queue/Receive',
        $argument,
    ...
    public function Complete(\Nitric\Proto\Queue\V1\QueueCompleteRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nitric.queue.v1.Queue/Complete',
        $argument,
