...
class StorageClient extends \Grpc\BaseStub {
    ...
    public function Read(\Nitric\Proto\Storage\V1\StorageReadRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nitric.storage.v1.Storage/Read',
        $argument,
    ...
    public function Write(\Nitric\Proto\Storage\V1\StorageWriteRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nitric.storage.v1.Storage/Write',
        $argument,
    ...
    public function Delete(\Nitric\Proto\Storage\V1\StorageDeleteRequest $argument,
      $metadata = [], $options = []) {
        return $this->_simpleRequest('/nitric.storage.v1.Storage/Delete',
        $argument,
