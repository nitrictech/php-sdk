...
class HttpTriggerContext extends \Google\Protobuf\Internal\Message
{
    ...
    private $headers;
    /**
     * The path params (if parseable by the membrane)
     *
     * Generated from protobuf field <code>map<string, string> path_params = 3;</code>
     */
    private $path_params;
    /**
     ...
     *           The request headers
     *     @type array|\Google\Protobuf\Internal\MapField $path_params
     *           The path params (if parseable by the membrane)
